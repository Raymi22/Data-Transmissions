    ...
    methods: {
        ...
        send: function () {
            if (this.validate(this.dataBits) === true){
                ...
                return axios.put("http://localhost:3001/message", {bits: encodedMessage}).then(
        ...
        encode: function(bits){
            if (this.numberOfDataBits === 4){
                ...
                var c1=this.parity(parseInt(bits[1].data)+parseInt(bits[2].data)+parseInt(bits[3].data)+parseInt(bits[4].data)+parseInt(bits[6].data)); // se calculeaza bitul de control de pe pozitia 1
                var c0=this.parity(parseInt(bits[0].data)+parseInt(bits[1].data)+parseInt(bits[2].data)+parseInt(bits[3].data)+parseInt(bits[4].data)+parseInt(bits[5].data)+parseInt(bits[6].data)+parseInt(bits[7].data));
